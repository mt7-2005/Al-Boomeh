...
namespace Al_BoomehDAL.Classes
{
    public class AddressService: IAddressService
    {
        ...
        public async Task<bool> DeleteAddress(int id)
        {
            ...
            if (address == null) throw new NotFoundException($"Not found address with id {id}");
        ...
        public async Task<bool> UpdateAddress(AddressDTO addressDTO)
        {
            ...
            if (address == null) throw new NotFoundException($"Not found address with id {addressDTO.id}");
