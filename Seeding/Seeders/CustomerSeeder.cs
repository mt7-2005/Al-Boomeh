    ...
    public static class CustomerSeeder
    {
        public static List<Customer> Generate(int count = 20000)
        {
            var faker = new Faker<Customer>()
                ...
                .RuleFor(c => c.DateOfBirth, f => DateOnly.FromDateTime(f.Date.Past(45, DateTime.Now.AddYears(-18))))
                .RuleFor(c => c.Gendor, f => f.Random.Int(0, 1))
                .RuleFor(c => c.CustomerStatus, f => f.Random.WeightedRandom(new[] { 1, 0 }, new[] { 0.95f, 0.05f }))
                .RuleFor(c => c.WalletBalance, f => f.Random.Decimal(0, 200))
